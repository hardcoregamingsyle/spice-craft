...
import { generateChallenge, generateSpeechFromText } from '../services/geminiService';
...
export const Game: React.FC = () => {
    ...
    const renderGameState = () => {
        switch(gameState) {
            ...
            case 'playing':
                if (currentChallenge) {
                    return <GameScreen challenge={currentChallenge} onNextChallenge={handleNextChallenge} challengeAudio={challengeAudio} />;
                }
        ...
        <>
            <header className="app-header" style={{ marginTop: 12 }}>
                ...
                <div style={{ marginLeft: 'auto', display: 'flex', gap: 10 }}>
                    <Button variant="ghost" onClick={startNewGame}>New Game</Button>
                    <Button variant="primary" onClick={() => alert('Save coming soon')}>Save Game</Button>
                </div>
            </header>
